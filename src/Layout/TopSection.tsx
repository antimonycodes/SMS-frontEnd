...
const TopSection = ({}: { handleCustomizationClick: () => void }) => {
  ...
  // };
  return (
    <div className="  fixed w-full bg-white shadow shadow-brand-500/20 z-[999] ">
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-4 mr-24">
          ...
          <div className="h-8 w-8 bg-brand-500 rounded-full flex items-center justify-center text-white font-semibold">
            A
          </div>
        </div>
      </div>
